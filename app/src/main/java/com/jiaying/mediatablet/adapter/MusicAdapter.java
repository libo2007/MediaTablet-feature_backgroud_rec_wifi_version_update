...
//
//    public VideoAdapter(MainActivity mContext, List<MusicEntity> mList, SoftReference<MainActivity> srMActivity) {
...
public class MusicAdapter extends BaseAdapter {
    ...
    public MusicAdapter(MainActivity mContext, List<MusicEntity> mList, SoftReference<MainActivity> srMActivity, TabletStateContext tabletStateContext) {
        this.mContext = mContext;
        this.mList = mList;
        this.srMActivity = srMActivity;
...
//        holder.cover_image.setImageResource(R.mipmap.bg_sky);
