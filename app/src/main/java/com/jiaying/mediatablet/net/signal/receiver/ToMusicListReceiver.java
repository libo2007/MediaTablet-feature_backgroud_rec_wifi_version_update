 ...
 */
public class ToMusicListReceiver extends Receiver{
    ...
    public ToMusicListReceiver(MainActivity mainActivity) {
    ...
    public void work() {
        ...
        tv_title.setText(R.string.music_list);
        ...
        this.mainActivity.switchFragment(R.id.fragment_container, new MusicListFragment());
    }
}
